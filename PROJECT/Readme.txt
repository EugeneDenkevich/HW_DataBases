...
There I implemented a simple database of grocery store and that contains tables like "client", "product", "purchases"... 8 tables and 7 of them has some relations.
